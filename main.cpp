...
void renderCurrentSpriteDisplay()
{
	...
	switch (current_sprite_id)  //bmpid, sprite id 'type'
	{
		...
		case 2:
			//bmp2 = ninja sprite
			current_sprite = ninja_bmps_array[0];
			break;
		case 3:
			//bmp2 = blue knight
			//current_sprite = bluf1;
			current_sprite = bluf_bmps_array[0];
			break;
		default:
	 ...
	 for (int spritenum=0;spritenum<MAX_NUMBER_NPC_SPRITES;spritenum++)
	 {
		 ...
		 switch(sprites[spritenum].bmpid)
		 {
		 	 case 1:
		 		 ...
		 		 break;
		 	 case 2:
				  drawplayersprite(ninja_bmps_array[0], sprites[spritenum].xpos, sprites[spritenum].ypos);
		 		//drawplayersprite_edit(ninjaf1, sprites[spritenum].xpos, sprites[spritenum].ypos);
		 		 drawspriteindexinfo(sprites[spritenum].bmpid, spritenum, sprites[spritenum].xpos, sprites[spritenum].ypos);
		 		break;
		 	 case 3:
		 		drawplayersprite_edit(bluf_bmps_array[0], sprites[spritenum].xpos, sprites[spritenum].ypos);
		 		 drawspriteindexinfo(sprites[spritenum].bmpid, spritenum, sprites[spritenum].xpos, sprites[spritenum].ypos);
		 		break;
		 	 default:
		 		 break;
...
void render_back_bmps()
{
	...
	else if (current_background_bitmap_id == 2) //green background
	{
		renderbackbmp(2);
	}
