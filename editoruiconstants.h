...
#define MAX_DIALOG_LINES 10 //4 lines of dialog per box

//

#define MAX_NUM_TAGS 20
#define MAX_NUM_MAPS 150
#define MAX_PATCH_BITMAPS 50
#define MAX_NUM_ACTIONTRIGGERS 30
